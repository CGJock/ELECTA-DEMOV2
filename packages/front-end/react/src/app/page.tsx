    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          {/* First Round Results Banner - Solo visible en segunda vuelta */}
          <FirstRoundResultsBanner isVisible={isSecondRound} />

          {/* Second Round Banner - Solo visible en post-primera vuelta */}
          {isPostFirstRound && (
          ...
          {/* Contenido principal - Solo visible en pre-elección y segunda vuelta */}
          {(isPreElection || isSecondRound) && (
            <>
              ...
              {/* Second Round Banner al final - Solo visible en segunda vuelta */}
              {isSecondRound && (
                <div 
